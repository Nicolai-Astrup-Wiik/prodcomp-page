...
export const AboutPage = () => {
	return (
		<>
			<p className={styles.paragraph} style={{ whiteSpace: "pre-line", lineHeight: "1.6" }}>
				...
				<br></br>
				<br></br>
				<strong><em>Pappenheimer (substantiv): En som man kjenner godt og vet hvordan vil opptre; en person man vet hvor man har.
